...
(function () {
  function Product(name, price, expirationDate) {
    ...
    this.getInfo = function () {
      ...
      nameSlice =
        nameSlice[0].toUpperCase() + nameSlice[name.length - 1].toUpperCase();
      var productId =
        nameSlice + this.id + ", " + this.name + ", " + this.price;
      return productId;
    };
  }
  ...
  function shoppingBag() {
    ...
    this.getMostExpensive = function () {
      ...
      var sortProducts = this.shoppingList
        .slice()
  ...
  function checkOutAndPay(myPaymentCard, myBag) {
    ...
    console.log(
      "totol price of products for buying : " +
    ...
    if (ifPurchaseValid) {
      ...
      console.log(
        "remaining fonds on you're payment card after purchase: " +
          newAccountBalance +
          " din."
      );
      ...
      return (
        "You need " +
        extraAmountForPaying +
        " more to be able to buy your items!"
      );
    }
  }

  var banana = new Product("banana", 120, "12/12/2023");
  var mango = new Product("mango", 110, "12/12/20123");
  var orange = new Product("orange", 140, "12/12/2023");
  ...
  var myPaymentCard = new PaymentCard(1700.5, "12/12/2024");
