...
(function () {
  ...
  function checkOutAndPay(paymentCard, shoppingBag) {
    ...
    console.log(
      "Total price of products for buying : " +
  ...
  var banana = new Product("banana", 120, "12/12/2024");
  var mango = new Product("mango", 110, "12/12/2024");
  var orange = new Product("orange", 140, "12/12/2024");
  ...
  var myPaymentCard = new PaymentCard(1700.5, "12/12/2025");
